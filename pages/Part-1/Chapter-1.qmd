# Managing Bioconductor releases

## Aims 

The aims of a `BiocBook` package are to: 

1. *Write*: draw up a compendium combining biological knowledge and bioinformatics aspects;
2. *Publish*: deploy a website to disseminate the compendium; 
3. *Build*: provide a Docker image to reproduce the same bioinformatics operations as illustrated in the compendium;
4. *Maintain*: synchronize the versioning of (1) the package, (2) the website and (3) the Docker images to Bioconductor release schedule. 
...
- Any **package** built using the `BiocBook` package is itself a `BiocBook`;
...
A `BiocBook` **package** can follow its own release life cycle. That being said, 
...
For example, for this package (`BiocBook.template`), the following **Docker image** versions are available: 

- [ghcr.io/js2264/biocbook.template:3.17](https://github.com/js2264/BiocBook.template/pkgs/container/biocbook.template/115910386?tag=RELEASE_3_17) 
- [ghcr.io/js2264/biocbook.template:devel](https://github.com/js2264/BiocBook.template/pkgs/container/biocbook.template/116021423?tag=devel) **<-- Current**
...
For example, for this package (`BiocBook.template`), the following **website** versions are available: 

- [https://js2264.github.io/BiocBook.template/3.17/](https://js2264.github.io/BiocBook.template/3.17/) 
- [https://js2264.github.io/BiocBook.template/devel/](https://js2264.github.io/BiocBook.template/devel/) **<-- Current**
