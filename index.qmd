...
This book introduces the reader to the `BiocBook` package, Docker image and website.
...
👉 [ghcr.io/js2264/biocbook.template](https://ghcr.io/js2264/biocbook.template) 🐳
...
#| eval: false
docker run -it ghcr.io/js2264/biocbook.template:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/js2264/biocbook.template:devel
```
...
#| eval: false
git clone git@github.com:js2264/BiocBook.template.git && cd BiocBook.template
