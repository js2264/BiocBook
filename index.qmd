...
- Create a fully configured `BiocBook` without leaving R (`BiocBook`)
- Write book chapters in `.qmd` files and enhanced markdown 
- Generate different book versions for different Bioconductor releases
- Provide different Docker images of your book for different Bioconductor releases
